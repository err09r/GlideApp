...
@Preview
@Composable
private fun RideGraphPreview(@PreviewParameter(RideRoutePreviewParameterProvider::class) route: RideRoute) {
    GlideAppTheme {
        RideGraph(
...
internal class RideRoutePreviewParameterProvider : PreviewParameterProvider<RideRoute> {
